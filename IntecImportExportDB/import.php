<?php
/* Класс для импорта CSV файла в БД
    Создаем ID пользователя, считываем, отправленный через форму файл.
    Далее работаем с БД с помощью запросов и по условию обновляем или добавляем товары в базе.
    Параллельно считаем, сколько товаров было добавлено, а сколько обновлено.
 *
 * */
